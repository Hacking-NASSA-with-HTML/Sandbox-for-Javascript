...
let contentOfResults1 = document.createTextNode("Hover on \"Hover on me!\", and then click.");
...
let contentOfResults2 = document.createTextNode("Reload the page to set initial state.");
